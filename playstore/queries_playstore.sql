...
SELECT app_name, price, rating FROM analytics WHERE rating < 3 ORDER BY price d
esc LIMIT 1;
...
SELECT category, count(category) FROM analytics GROUP BY category HAVING count(
category) > 300;
